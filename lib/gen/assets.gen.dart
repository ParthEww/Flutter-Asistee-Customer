...
class $AssetsAnimationsGen {
  ...
  /// File path: assets/animations/anim_loader.json
  LottieGenImage get animLoader =>
      const LottieGenImage('assets/animations/anim_loader.json');

  /// Directory path: assets/animations
  String get path => 'assets/animations';

  /// List of all assets
  List<LottieGenImage> get values => [animLoader];
}
...
class $AssetsImagesPngGen {
  ...
  /// File path: assets/images/png/onboard_img_2.png
  AssetGenImage get onboardImg2 =>
      const AssetGenImage('assets/images/png/onboard_img_2.png');

  /// File path: assets/images/png/onboard_img_3.png
  AssetGenImage get onboardImg3 =>
      const AssetGenImage('assets/images/png/onboard_img_3.png');

  /// Directory path: assets/images/png
  String get path => 'assets/images/png';
...
class $AssetsImagesSvgGen {
  ...
  /// File path: assets/images/svg/asistee_logo_white_with_text.svg
  SvgGenImage get asisteeLogoWhiteWithText =>
      const SvgGenImage('assets/images/svg/asistee_logo_white_with_text.svg');
  ...
  SvgGenImage get eyeSlash =>
      const SvgGenImage('assets/images/svg/eye-slash.svg');
